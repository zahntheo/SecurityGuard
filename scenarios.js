  ...
  levels: [
    {
      ...
      options: [
        ...
        {
          label: "OPTION B",
          text: "I copied the entire contract text into the chat so you can review everything.",
          document: "txt",
          score: 0,
          feedback: {
            key: "risky",
            label: "NOT SAFE",
            summary:
              "A full phone contract can reveal account details, address data, signatures and so on.",
            ...
            remember: "Only share the information needed for the task.",
          },
        },
        {
          label: "OPTION C",
          ...
          feedback: {
            ...
            label: "ALMOST",
            summary:
              "Better - direct identifiers are hidden. But redacted contract pages can still expose metadata and sensitive context.",
            modalTitle: "Redacted contract pages can still expose context.",
            ...
            points: [
              {
                ...
                text: "Removing your address and IBAN reduces the most obvious risk.",
              },
              {
                type: "risk",
                mark: "!",
                title: "Metadata remains",
                text: "Document IDs, timestamps and file names may still identify the contract or customer account.",
              },
              {
                type: "risk",
                mark: "!",
                title: "Identity theft",
                text: "Attackers may use these details to pretend to be you or verify your identity when contacting service providers.",
              },
            ],
            remember:
              "If you can type the relevant details, do that instead of uploading a file.",
          },
        },
      ],
    },
